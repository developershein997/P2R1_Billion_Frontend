                  ...
                  <div className="flex items-center">
                    <div>
                      <img
                          ...
                          src={"https://luckymillion.pro/api/../" + selectedBank.image}
                          alt={selectedBank.payment_type}
                      />
                    </div>
                    <div className="ml-3">
                      <h6 className="font-bold text-white">{selectedBank.account_name}</h6>
                ...
                <div className="space-y-2 mb-4">
                  {banks && banks.map((bank, index) => (
                      <div key={index} onClick={() => {
                        ...
                        <img src={"https://luckymillion.pro/api/../" + bank.image} className="w-10 h-10 rounded-md object-cover" alt="bank" />
                        <div>
